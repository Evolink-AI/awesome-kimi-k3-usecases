...
129 vaka yüksek güvenilirlikli herkese açık kaynaklardan gelir. Başlıklar ve yazarlar orijinale bağlanır; zayıf, yinelenen veya yetersiz kanıtlı adaylar dışarıda kalır

## 📊 Genel bakış

- Üreticiler ve uygulayıcılardan 129 yüksek güven vakası
...
| Section | Cases |
|---|---|
| [Etkileşimli oyunlar ve 3D](#games-3d) | 41 |
| [Frontend ve hareketli tasarım](#frontend-motion) | 32 |
| [Kodlama ve entegrasyonlar](#coding-integrations) | 18 |
| [Değerlendirme ve sınırlar](#evaluation-limits) | 48 |
...
| [VulcanBench maliyetlerini incele](#case-100) | Değerlendirme ve sınırlar | Bu örnekle Kimi K3ün “VulcanBench maliyetlerini incele” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Benchmark |
| [Minecraft derinliğini karşılaştır](#case-101) | Etkileşimli oyunlar ve 3D | Bu örnekle Kimi K3ün “Minecraft derinliğini karşılaştır” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Evaluation |
| [Fallout FPS klonu oluştur](#case-102) | Etkileşimli oyunlar ve 3D | Bu örnekle Kimi K3ün “Fallout FPS klonu oluştur” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Demo |
| [Premium web sitesi eğitimini izle](#case-103) | Frontend ve hareketli tasarım | Bu örnekle Kimi K3ün “Premium web sitesi eğitimini izle” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Tutorial |
| [Çift sarkaç fiziğini benchmark et](#case-104) | Değerlendirme ve sınırlar | Bu örnekle Kimi K3ün “Çift sarkaç fiziğini benchmark et” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Benchmark |
| [Veri merkezi RPG yayımla](#case-105) | Etkileşimli oyunlar ve 3D | Bu örnekle Kimi K3ün “Veri merkezi RPG yayımla” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Demo |
| [Humanoid frontend maliyetlerini karşılaştır](#case-106) | Frontend ve hareketli tasarım | Bu örnekle Kimi K3ün “Humanoid frontend maliyetlerini karşılaştır” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Benchmark |
| [ReactBench hazır oluşunu incele](#case-107) | Değerlendirme ve sınırlar | Bu örnekle Kimi K3ün “ReactBench hazır oluşunu incele” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Benchmark |
| [3D araba oyunu oluştur](#case-108) | Etkileşimli oyunlar ve 3D | Bu örnekle Kimi K3ün “3D araba oyunu oluştur” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Demo |
| [Kimi K3ü Claude Codeda çalıştır](#case-109) | Kodlama ve entegrasyonlar | Bu örnekle Kimi K3ün “Kimi K3ü Claude Codeda çalıştır” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin. | Integration |
| [AA-Briefcase ile Kimi K3ü değerlendir](#case-110) | Değerlendirme ve sınırlar | Leaderboard iddialarına güvenmeden önce Kimi K3ün agentic bilgi işi görevlerindeki durumunu AA-Briefcase sonuçlarıyla değerlendir. | Benchmark |
| [Geometry Dash klonlarını karşılaştır](#case-111) | Etkileşimli oyunlar ve 3D | Aynı brief ile yapılan oyun buildlerini karşılaştırarak Kimi K3ün oynanabilir mobil tarzı prototipler için yeterli olup olmadığını değerlendir. | Evaluation |
| [Command Code retro oyun testi](#case-112) | Etkileşimli oyunlar ve 3D | Command Codeda çok modelli bir design run kullanarak Kimi K3ün gameplay özelliklerini ve model maliyetlerini karşılaştır. | Evaluation |
| [Frontend leaderboard uyarılarını denetle](#case-113) | Değerlendirme ve sınırlar | Kimi K3ün leaderboard zaferlerini daha geniş coding ve cost iddialarından ayırmak için bu limitation notunu kullan. | Limit |
| [StackPerf mimari sonuçlarını karşılaştır](#case-114) | Değerlendirme ve sınırlar | StackPerf ile Kimi K3 ve Qwen 3.8i architecture quality, speed ve tool-call behavior açısından karşılaştır. | Benchmark |
| [Three.js Kimi-vs-GLM build karşılaştır](#case-115) | Frontend ve hareketli tasarım | Aynı procedural Three.js promptlarını Kimi K3 ve GLM 5.2 ile çalıştırarak frontend ve 3D build davranışını karşılaştır. | Benchmark |
| [Space Discoverer oyununu benchmarkla](#case-116) | Etkileşimli oyunlar ve 3D | Generic 3D browser-game brief altında model çıktılarını karşılaştırmak için Space Discoverer mini-benchmarkını kullan. | Benchmark |
| [Gerçek yolla driving game yap](#case-117) | Etkileşimli oyunlar ve 3D | Kimi K3ü Blender ve Godot ile birleştirerek gerçek yerel yol haritası etrafında driving game prototiple. | Demo |
| [Monument Valley prompt maliyetlerini karşılaştır](#case-118) | Değerlendirme ve sınırlar | Tek bir Monument Valley-style prompt ile Kimi K3 ve benzer modellerin visual quality, runtime ve cost değerlerini karşılaştır. | Benchmark |
| [Kimiyi claude-code-router ile yönlendir](#case-119) | Kodlama ve entegrasyonlar | Gereksiz proxy mode kullanmadan Kimi K3ü mevcut Claude Code workflow içinde claude-code-router ile dene. | Integration |
| [Kimi K3ü Surge Indexte ölç](#case-120) | Değerlendirme ve sınırlar | SurgeAI sonuçlarını kullanarak Kimi K3ün günlük sohbet gücünü kurumsal ajan ve bilim görevlerindeki zayıflıklarından ayır. | Benchmark |
| [Referansla landing page oluştur](#case-121) | Frontend ve hareketli tasarım | Landing page üretimini test ederken Kimi K3e güçlü görsel referanslar ve yinelemeli yönlendirme ver. | Demo |
| [Dikey platform oyunu yap](#case-122) | Etkileşimli oyunlar ve 3D | Kısa bir oyun brifiyle Kimi K3ün tek dosyalı tarayıcı prototipi döndürüp döndürmediğini test et. | Demo |
| [PDE solver hatalarını ölç](#case-123) | Değerlendirme ve sınırlar | PDE benchmark hatalarını kullanarak Kimi K3 çevresinde sembolik veya sayısal görevlerin nerede doğrulama istediğini belirle. | Benchmark |
| [ClinicalBench EHR vakalarını incele](#case-124) | Değerlendirme ve sınırlar | ClinicalBench EHR vakalarıyla Kimi K3ün nerede başarılı olduğunu ve tanı akıl yürütmesinin nerede zorlandığını incele. | Benchmark |
| [Açık ajan harness çalıştır](#case-125) | Kodlama ve entegrasyonlar | Araç kullanan görevlerde Kimi K3ü diğer frontier modellerle karşılaştırmak için ortak ajan harness kullan. | Benchmark |
| [Vergi hesaplarını değerlendir](#case-126) | Değerlendirme ve sınırlar | Frontend gücünün vergi hesaplarına taşındığını varsaymak yerine Kimi K3ü bu yüklerde ayrı test et. | Limit |
| [Üretilen Geometry Dashi doğrula](#case-127) | Etkileşimli oyunlar ve 3D | Kimi K3 oyun çıktısını bitmiş prototip saymadan önce solver ve tarayıcı playtesti ile birlikte kullan. | Benchmark |
| [3D parçacık sistemi simüle et](#case-128) | Frontend ve hareketli tasarım | Parçacık simülasyonu promptlarıyla Kimi K3ün hareket kalitesini kapalı modellerle karşılaştır. | Evaluation |
| [Kimi Codex OAuth ile çalıştır](#case-129) | Kodlama ve entegrasyonlar | Kimi K3 kodlama akışında manuel API key kurulumundan kaçınmak gerektiğinde Codex OAuth yolunu kullan. | Integration |
| [Bileşik computer use kıyaslaması](#case-130) | Değerlendirme ve sınırlar | Kimi K3 u sentetik skorlar yerine birleşik computer use görevlerinde karşılaştırmak. | Benchmark |
| [Derin deniz anlatım hattı kurmak](#case-131) | Frontend ve hareketli tasarım | Anlatı odaklı bir promptu sahne, metin, hareket ve açıklamayı düzenleyen görsel bir hatta dönüştürmek. | Demo |
| [Altı bacaklı robot simülasyonu](#case-132) | Etkileşimli oyunlar ve 3D | Kimi K3 ile bacak hareketi ve görünür davranış içeren 3D robotik sahne prototipi üretmek. | Demo |
| [Landing page leri kör test etmek](#case-133) | Frontend ve hareketli tasarım | Model adını açıklamadan landing page çıktıları üzerinden Kimi K3 ün frontend kalitesini değerlendirmek. | Benchmark |
| [Mekanik 3D ayrıntı prototiplemek](#case-134) | Frontend ve hareketli tasarım | Kimi K3 e görsel detay ve render kısıtları olan küçük bir mekanik 3D sahne ürettirmek. | Demo |
| [Expo mobil arayüzünü yeniden kurmak](#case-135) | Frontend ve hareketli tasarım | Kimi K3 ü mobil Expo arayüzünde yapı, bileşenler ve görsel bitiş açısından test etmek. | Evaluation |
| [Üretim backend ini stres testine almak](#case-136) | Kodlama ve entegrasyonlar | Kimi K3 ü daha gerçekçi backend akışında entegrasyon, kod muhakemesi ve sınırlar açısından incelemek. | Evaluation |
| [Codex i opencodex üzerinden yönlendirmek](#case-137) | Kodlama ve entegrasyonlar | Kimi K3 ü Codex/opencodex döngüsüne bağlayarak somut bir agent yönlendirme denemesi yapmak. | Integration |
| [Oyun ayar döngülerini otomatikleştirmek](#case-138) | Etkileşimli oyunlar ve 3D | Gameplay kaydeden, analiz eden, parametreleri değiştiren ve testi yeniden çalıştıran bir harnais kurmak. | Integration |
| [Web tasarım öğreticisini izlemek](#case-139) | Frontend ve hareketli tasarım | Tam bir öğretici üzerinden Kimi K3 ün layout, hareket ve görsel parlatmayı nasıl kurduğunu incelemek. | Tutorial |
...
<a id="case-101"></a>
### Case 101: [Minecraft derinliğini karşılaştır](https://x.com/vikktorrrre/status/2079294696459804762) (by [@vikktorrrre](https://x.com/vikktorrrre))

**Bu örnekle Kimi K3ün “Minecraft derinliğini karşılaştır” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “Minecraft derinliğini karşılaştır” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-102"></a>
### Case 102: [Fallout FPS klonu oluştur](https://x.com/kirillk_web3/status/2079290747585437781) (by [@kirillk_web3](https://x.com/kirillk_web3))

**Bu örnekle Kimi K3ün “Fallout FPS klonu oluştur” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “Fallout FPS klonu oluştur” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-105"></a>
### Case 105: [Veri merkezi RPG yayımla](https://x.com/demian_ai/status/2079239035596218578) (by [@demian_ai](https://x.com/demian_ai))

**Bu örnekle Kimi K3ün “Veri merkezi RPG yayımla” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “Veri merkezi RPG yayımla” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-108"></a>
### Case 108: [3D araba oyunu oluştur](https://x.com/LexnLin/status/2079233761242235081) (by [@LexnLin](https://x.com/LexnLin))

**Bu örnekle Kimi K3ün “3D araba oyunu oluştur” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “3D araba oyunu oluştur” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-111"></a>
### Case 111: [Geometry Dash klonlarını karşılaştır](https://x.com/Nekt_0/status/2079629004483465473) (by [@Nekt_0](https://x.com/Nekt_0))

**Aynı brief ile yapılan oyun buildlerini karşılaştırarak Kimi K3ün oynanabilir mobil tarzı prototipler için yeterli olup olmadığını değerlendir.**

Nekt, Kimi K3ün yaklaşık 30 dakika ve 200.000 token harcayarak zıplama, engeller, seviyeler, müzik ve görsel efektler içeren Geometry Dash tarzı bir klon yaptığını ve videoda Claude Fable 5 buildi ile karşılaştırdığını söylüyor.
...
<a id="case-112"></a>
### Case 112: [Command Code retro oyun testi](https://x.com/naymur_dev/status/2079627963000398334) (by [@naymur_dev](https://x.com/naymur_dev))

**Command Codeda çok modelli bir design run kullanarak Kimi K3ün gameplay özelliklerini ve model maliyetlerini karşılaştır.**

Naymur, Command Codeda Fable 5, GPT-5.6 Sol, Grok 4.5 ve Kimi K3 ile aynı /design promptunu çalıştırdığını bildiriyor. Posta göre Kimi K3 gameplay, level up, bullets ve boss fights içeren ASCII retro game üretmiş ve maliyeti $0.15 olmuş.
...
<a id="case-116"></a>
### Case 116: [Space Discoverer oyununu benchmarkla](https://x.com/fabriciocarraro/status/2079548607393382528) (by [@fabriciocarraro](https://x.com/fabriciocarraro))

**Generic 3D browser-game brief altında model çıktılarını karşılaştırmak için Space Discoverer mini-benchmarkını kullan.**

Fabricio Carraro, Claude Fable 5, GPT-5.6 Sol ve Kimi K3ü maksimum reasoning ayarlarında karşılaştıran mini-benchmarkı bildiriyor. Görev Space Discoverer adlı 3D browser game ve üç model de WebGL 2 üzerinde Three.jsye yönelmiş.
...
<a id="case-117"></a>
### Case 117: [Gerçek yolla driving game yap](https://x.com/bijanbowen/status/2079526003643179102) (by [@bijanbowen](https://x.com/bijanbowen))

**Kimi K3ü Blender ve Godot ile birleştirerek gerçek yerel yol haritası etrafında driving game prototiple.**

Bijan Bowen, Kimi K3ün Blender ve Godot kullanarak yaratıcının yakınındaki gerçek bir yol parçasını map basis alan bir driving game yaptığını gösteriyor. Ekli video build durumunun public evidenceıdır.
...
<a id="case-122"></a>
### Case 122: [Dikey platform oyunu yap](https://x.com/diegocabezas01/status/2079946676270219488) (by [@diegocabezas01](https://x.com/diegocabezas01))

**Kısa bir oyun brifiyle Kimi K3ün tek dosyalı tarayıcı prototipi döndürüp döndürmediğini test et.**

Diego Cabezas, oyuncunun hareketli platformlarda sürekli daha yükseğe zıpladığı bir dikey platform oyununu Kimi K3 Max ile gösteriyor. Gönderi tek denemelik, tek HTML sonucunu kaydediyor.
...
<a id="case-127"></a>
### Case 127: [Üretilen Geometry Dashi doğrula](https://x.com/Kirratr/status/2079902410042909108) (by [@Kirratr](https://x.com/Kirratr))

**Kimi K3 oyun çıktısını bitmiş prototip saymadan önce solver ve tarayıcı playtesti ile birlikte kullan.**

Kirratr, aynı Geometry Dash tarzı briefte Kimi K3ün 36:53 sürdüğünü bildiriyor. Beam-search solver 64 zıplamalı kazanan rota bulup tarayıcıda yeniden oynatıyor ve konsol hatası görmüyor.
...
<a id="case-132"></a>
### Case 132: [Altı bacaklı robot simülasyonu](https://x.com/DilumSanjaya/status/2080335531108716750) (by [@DilumSanjaya](https://x.com/DilumSanjaya))

**Kimi K3 ile bacak hareketi ve görünür davranış içeren 3D robotik sahne prototipi üretmek.**

Kaynak: DilumSanjaya, Kimi K3 ile hazırlanmış bir altı bacaklı robot simülasyonu paylaşıyor. Vaka 3D etkileşim demosu olarak korunur; fiziksel robot doğrulaması iddia edilmez.
...
<a id="case-138"></a>
### Case 138: [Oyun ayar döngülerini otomatikleştirmek](https://x.com/Oluwaphilemon1/status/2080187637806043200) (by [@Oluwaphilemon1](https://x.com/Oluwaphilemon1))

**Gameplay kaydeden, analiz eden, parametreleri değiştiren ve testi yeniden çalıştıran bir harnais kurmak.**

Kaynak: Oluwaphilemon1, Three.js projelerinde Kimi K3 kullanımını ve oyun içi ayar döngüsünü anlatıyor. Akış manuel playtesting ihtiyacını azaltır, ancak kamuya açık paylaşıma dayanır.
...
<a id="case-103"></a>
### Case 103: [Premium web sitesi eğitimini izle](https://x.com/_guillecasaus/status/2079258261014908980) (by [@_guillecasaus](https://x.com/_guillecasaus))

**Bu örnekle Kimi K3ün “Premium web sitesi eğitimini izle” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “Premium web sitesi eğitimini izle” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-106"></a>
### Case 106: [Humanoid frontend maliyetlerini karşılaştır](https://x.com/ChrisGPT/status/2079236298464796958) (by [@ChrisGPT](https://x.com/ChrisGPT))

**Bu örnekle Kimi K3ün “Humanoid frontend maliyetlerini karşılaştır” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “Humanoid frontend maliyetlerini karşılaştır” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-115"></a>
### Case 115: [Three.js Kimi-vs-GLM build karşılaştır](https://x.com/thehypedotnews/status/2079553731218325840) (by [@thehypedotnews](https://x.com/thehypedotnews))

**Aynı procedural Three.js promptlarını Kimi K3 ve GLM 5.2 ile çalıştırarak frontend ve 3D build davranışını karşılaştır.**

The Hype, Kimi K3 ve GLM 5.2yi üç single-file HTML ve Three.js promptuyla test ettiğini söylüyor: live CRT canvas texturelı 80ler salonu, drivetrain kinematicsli road bike ve glass aquarium scene.
...
<a id="case-121"></a>
### Case 121: [Referansla landing page oluştur](https://x.com/Oluwaphilemon1/status/2079951300108697683) (by [@Oluwaphilemon1](https://x.com/Oluwaphilemon1))

**Landing page üretimini test ederken Kimi K3e güçlü görsel referanslar ve yinelemeli yönlendirme ver.**

Oluwaphilemon, bir görsel referans ve ayrıntılı prompt ile landing page oluşturmayı anlatıyor. Kaynak, Kiminin önce bisikleti 3D modellemeye çalıştığını, ardından birkaç yönlendirme ile daha temiz sonuca ulaştığını belirtiyor.
...
<a id="case-128"></a>
### Case 128: [3D parçacık sistemi simüle et](https://x.com/jadeferrara_/status/2079884161251262540) (by [@jadeferrara_](https://x.com/jadeferrara_))

**Parçacık simülasyonu promptlarıyla Kimi K3ün hareket kalitesini kapalı modellerle karşılaştır.**

Jade Ferrara, Kimi K3 ve Opus 4.8e aynı 3D parçacık sistemi promptunu verdiğini bildiriyor. Kimi daha organik dağılım, daha akıcı hareket ve daha düşük API maliyeti göstermiş.
...
<a id="case-131"></a>
### Case 131: [Derin deniz anlatım hattı kurmak](https://x.com/N01ennn/status/2080391368644657460) (by [@N01ennn](https://x.com/N01ennn))

**Anlatı odaklı bir promptu sahne, metin, hareket ve açıklamayı düzenleyen görsel bir hatta dönüştürmek.**

Kaynak: N01ennn, Kimi K3 ile derin deniz üzerine açıklayıcı bir içerik akışı gösteriyor. Paylaşım, anlatı yapısı ile görsel ve animasyonu birleştiren somut bir demo sunuyor.
...
<a id="case-133"></a>
### Case 133: [Landing page leri kör test etmek](https://x.com/contraben/status/2080329043639947338) (by [@contraben](https://x.com/contraben))

**Model adını açıklamadan landing page çıktıları üzerinden Kimi K3 ün frontend kalitesini değerlendirmek.**

Kaynak: contraben, farklı modellerin ürettiği landing page leri kör test olarak paylaşıyor. Bu vaka görsel değerlendirme yöntemini belgeler; genel benchmark iddiası taşımaz.
...
<a id="case-134"></a>
### Case 134: [Mekanik 3D ayrıntı prototiplemek](https://x.com/0xDominiqq/status/2080316573210784230) (by [@0xDominiqq](https://x.com/0xDominiqq))

**Kimi K3 e görsel detay ve render kısıtları olan küçük bir mekanik 3D sahne ürettirmek.**

Kaynak: 0xDominiqq, Kimi K3 ile oluşturulmuş mekanik veya endüstriyel bir parça gösteriyor. Faydalı sinyal, yalnızca paylaşılan demo ile desteklenen hassas görsel prototiplemedir.
...
<a id="case-135"></a>
### Case 135: [Expo mobil arayüzünü yeniden kurmak](https://x.com/thebuggeddev/status/2080295524142587933) (by [@thebuggeddev](https://x.com/thebuggeddev))

**Kimi K3 ü mobil Expo arayüzünde yapı, bileşenler ve görsel bitiş açısından test etmek.**

Kaynak: thebuggeddev, Kimi K3 ile yapılmış bir mobil arayüz yeniden üretimini paylaşıyor. Vaka frontend çıktısı değerlendirmesidir; üretim kalitesinin tamamını kapsadığı iddia edilmez.
...
<a id="case-139"></a>
### Case 139: [Web tasarım öğreticisini izlemek](https://x.com/cyrilXBT/status/2080176332890345501) (by [@cyrilXBT](https://x.com/cyrilXBT))

**Tam bir öğretici üzerinden Kimi K3 ün layout, hareket ve görsel parlatmayı nasıl kurduğunu incelemek.**

Kaynak: cyrilXBT, Kimi K3 ile özel bir site yapımını anlatan 13 dakikalık bir öğretici paylaşıyor. Vaka kaynak destekli eğitim akışıdır; prompt galerisi değildir.
...
<a id="case-109"></a>
### Case 109: [Kimi K3ü Claude Codeda çalıştır](https://x.com/boxmining/status/2079115758618239337) (by [@boxmining](https://x.com/boxmining))

**Bu örnekle Kimi K3ün “Kimi K3ü Claude Codeda çalıştır” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “Kimi K3ü Claude Codeda çalıştır” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-119"></a>
### Case 119: [Kimiyi claude-code-router ile yönlendir](https://x.com/sairahul1/status/2079393675885588855) (by [@sairahul1](https://x.com/sairahul1))

**Gereksiz proxy mode kullanmadan Kimi K3ü mevcut Claude Code workflow içinde claude-code-router ile dene.**

Sai Rahul, Moonshot sponsorlu claude-code-router Kimi K3 desteğini anlatıyor: built-in presets, API key veya subscription import, native subscription routing, balance/usage dashboard, failover, cache pricing ve gerekmedikçe proxy modeu kapalı tutma uyarısı.
...
<a id="case-125"></a>
### Case 125: [Açık ajan harness çalıştır](https://x.com/ShenSeanChen/status/2079914609222221976) (by [@ShenSeanChen](https://x.com/ShenSeanChen))

**Araç kullanan görevlerde Kimi K3ü diğer frontier modellerle karşılaştırmak için ortak ajan harness kullan.**

Sean Chen; ajan döngüsü, bellek alma kapısı, araç çağrıları, değerlendirme, tracing ve maliyet panosu içeren açık kaynak harness ile Kimi K3ü yarıştırdığını anlatıyor.
...
<a id="case-129"></a>
### Case 129: [Kimi Codex OAuth ile çalıştır](https://x.com/biscuitweb3/status/2079844959843197342) (by [@biscuitweb3](https://x.com/biscuitweb3))

**Kimi K3 kodlama akışında manuel API key kurulumundan kaçınmak gerektiğinde Codex OAuth yolunu kullan.**

biscuitweb3, Kimi K3ün OAuth ile Codex içinde çalıştığını ve ek API key kurulumu gerektirmediğini bildiriyor. Ekteki ekran görüntüsü entegrasyon kanıtı sağlıyor.
...
<a id="case-136"></a>
### Case 136: [Üretim backend ini stres testine almak](https://x.com/hqmank/status/2080267878256005255) (by [@hqmank](https://x.com/hqmank))

**Kimi K3 ü daha gerçekçi backend akışında entegrasyon, kod muhakemesi ve sınırlar açısından incelemek.**

Kaynak: hqmank, Kimi K3 ü üretim backend senaryosunda denediğini aktarıyor. Vaka kod entegrasyonu değerlendirmesi olarak tutulur; bağımsız ücretli runtime testi yapılmamıştır.
...
<a id="case-137"></a>
### Case 137: [Codex i opencodex üzerinden yönlendirmek](https://x.com/cyrilXBT/status/2080252333829628163) (by [@cyrilXBT](https://x.com/cyrilXBT))

**Kimi K3 ü Codex/opencodex döngüsüne bağlayarak somut bir agent yönlendirme denemesi yapmak.**

Kaynak: cyrilXBT, Kimi K3 kullanan bir opencodex kurulumu paylaşıyor. Vaka araç entegrasyonunu belgeler ve bildirilen kurulum ile yerel doğrulama sınırını korur.
...
<a id="case-100"></a>
### Case 100: [VulcanBench maliyetlerini incele](https://x.com/morganlinton/status/2079358902194569357) (by [@morganlinton](https://x.com/morganlinton))

**Bu örnekle Kimi K3ün “VulcanBench maliyetlerini incele” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “VulcanBench maliyetlerini incele” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-104"></a>
### Case 104: [Çift sarkaç fiziğini benchmark et](https://x.com/AlicanKiraz0/status/2079241239736504768) (by [@AlicanKiraz0](https://x.com/AlicanKiraz0))

**Bu örnekle Kimi K3ün “Çift sarkaç fiziğini benchmark et” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “Çift sarkaç fiziğini benchmark et” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-107"></a>
### Case 107: [ReactBench hazır oluşunu incele](https://x.com/aidenybai/status/2079233934693650567) (by [@aidenybai](https://x.com/aidenybai))

**Bu örnekle Kimi K3ün “ReactBench hazır oluşunu incele” görevindeki gerçek iş akışını, maliyetini veya sınırlarını değerlendirin.**

Kaynak gönderi “ReactBench hazır oluşunu incele” için yazar açıklaması, sonuç medyası veya benchmark/eğitim bilgisi gibi açık kanıtlar sunar. Bu depo yalnızca doğrulanabilir bilgileri korur; yayımlanmamış prompt veya adımları uydurmaz.
...
<a id="case-110"></a>
### Case 110: [AA-Briefcase ile Kimi K3ü değerlendir](https://x.com/ArtificialAnlys/status/2079715807983210572) (by [@ArtificialAnlys](https://x.com/ArtificialAnlys))

**Leaderboard iddialarına güvenmeden önce Kimi K3ün agentic bilgi işi görevlerindeki durumunu AA-Briefcase sonuçlarıyla değerlendir.**

Artificial Analysis, Kimi K3ün AA-Briefcase üzerinde 1543 Elo ile Claude Fable 5in arkasında ikinci olduğunu; ancak bu benchmarkta görev başına neredeyse bir saat sürdüğünü ve Opus 4.8den pahalıya geldiğini bildiriyor.
...
<a id="case-113"></a>
### Case 113: [Frontend leaderboard uyarılarını denetle](https://x.com/RetroChainer/status/2079622227796885850) (by [@RetroChainer](https://x.com/RetroChainer))

**Kimi K3ün leaderboard zaferlerini daha geniş coding ve cost iddialarından ayırmak için bu limitation notunu kullan.**

RetroChainer Frontend Code Arena liderliğini ve listelenen fiyatı doğruluyor; ancak sıralamanın tek boarda özel olduğunu, weightslerin post sırasında public olmadığını, job başı tasarrufun tek tasktan geldiğini ve max reasoningin küçük işlerde çok token yakabildiğini belirtiyor.
...
<a id="case-114"></a>
### Case 114: [StackPerf mimari sonuçlarını karşılaştır](https://x.com/tamsi_besson/status/2079573266855834071) (by [@tamsi_besson](https://x.com/tamsi_besson))

**StackPerf ile Kimi K3 ve Qwen 3.8i architecture quality, speed ve tool-call behavior açısından karşılaştır.**

Tamsi Bessonun StackPerf snapshotına göre Kimi K3 kalite tarafında Qwen 3.8 Max Previewı az farkla geçiyor ve toplamda daha hızlı; buna karşılık Qwende failed tool call yokken Kimi daha çok tool call içinde 2 hata yapıyor.
...
<a id="case-118"></a>
### Case 118: [Monument Valley prompt maliyetlerini karşılaştır](https://x.com/AiHubMix/status/2079507420083294557) (by [@AiHubMix](https://x.com/AiHubMix))

**Tek bir Monument Valley-style prompt ile Kimi K3 ve benzer modellerin visual quality, runtime ve cost değerlerini karşılaştır.**

AiHubMix, Claude Fable 5, Kimi K3 ve GPT-5.6 Solu tek Monument Valley-style prompt üzerinde karşılaştırıyor. Post Fableı en coherent, Kimiyi 52m30s ve $1.50 ile en yavaş, GPT-5.6 Solu en hızlı ve ucuz ama spatial logicte daha zayıf olarak bildiriyor.
...
<a id="case-120"></a>
### Case 120: [Kimi K3ü Surge Indexte ölç](https://x.com/echen/status/2080021575190110523) (by [@echen](https://x.com/echen))

**SurgeAI sonuçlarını kullanarak Kimi K3ün günlük sohbet gücünü kurumsal ajan ve bilim görevlerindeki zayıflıklarından ayır.**

Eric Chen, SurgeAIın Kimi K3ü günlük sohbet botları, kurumsal ajanlar, derin akıl yürütme ve frontier bilim kapsayan bir dizinde çalıştırdığını aktarıyor. Gönderi, Kimi K3ün günlük sohbette güçlü; ajan ve bilim görevlerinde Fable ile Solun gerisinde olduğunu söylüyor.
...
<a id="case-123"></a>
### Case 123: [PDE solver hatalarını ölç](https://x.com/lanyon_ai/status/2079931884511887740) (by [@lanyon_ai](https://x.com/lanyon_ai))

**PDE benchmark hatalarını kullanarak Kimi K3 çevresinde sembolik veya sayısal görevlerin nerede doğrulama istediğini belirle.**

Lanyon AI, basit doğrusal PDElerde kendi nörosembolik mimarisini Kimi K3 dahil frontier modellerle karşılaştırıyor. Kaynak, ayrıntılı promptlara rağmen matematiksel ve hesaplamalı hatalar bildiriyor.
...
<a id="case-124"></a>
### Case 124: [ClinicalBench EHR vakalarını incele](https://x.com/mkurman88/status/2079918374977413534) (by [@mkurman88](https://x.com/mkurman88))

**ClinicalBench EHR vakalarıyla Kimi K3ün nerede başarılı olduğunu ve tanı akıl yürütmesinin nerede zorlandığını incele.**

Michael Kurman, sanal EHR ortamındaki 10 acil servis vakasında Kimi K3 için ClinicalBench v0.0.4 sonuçlarını aktarıyor. Kimi K3 10 vakanın 7sini çözüyor ve 6. vakada zorlanıyor.
...
<a id="case-126"></a>
### Case 126: [Vergi hesaplarını değerlendir](https://x.com/michaelrbock/status/2079913117698666964) (by [@michaelrbock](https://x.com/michaelrbock))

**Frontend gücünün vergi hesaplarına taşındığını varsaymak yerine Kimi K3ü bu yüklerde ayrı test et.**

Michael Bock, 50 gerçekçi federal ve eyalet vergi beyannamesinde Kimi K3ü test ettiğini bildiriyor. Kaynak TaxCalcBenchte Kimi K3 için 6%, GPT-5.6 Sol için 58%, Fable 5 için 4% veriyor.
...
<a id="case-130"></a>
### Case 130: [Bileşik computer use kıyaslaması](https://x.com/YangFanYun/status/2080442432794325003) (by [@YangFanYun](https://x.com/YangFanYun))

**Kimi K3 u sentetik skorlar yerine birleşik computer use görevlerinde karşılaştırmak.**

Kaynak: YangFanYun, Kimi K3 u Gemini 3, GPT-5 ve GLM 4.6 ile birlikte bileşik computer use benchmark ında konumlandırıyor. Bu, uzun görevlerde pratik sınırları izlemek için kullanılan öz bildirime dayalı bir değerlendirmedir.
