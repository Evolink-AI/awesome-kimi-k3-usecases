...
<a href="https://evolink.ai/kimi-k3?utm_source=github&utm_medium=banner&utm_campaign=awesome-kimi-k3-usecases&utm_content=readme_banner"><img src="https://pub-62cf7640cd0f4066b60933bd2e9b85ef.r2.dev/github-repo-media/awesome-kimi-k3-usecases/images/es.png" alt="Kimi K3 usecase repository banner" width="760"></a>
...
Los diez casos de esta primera edición proceden del paquete de fuentes proporcionado. Los títulos enlazan a las publicaciones originales y los autores a sus perfiles
...
- 10 casos seleccionados de creadores y profesionales
- Incluye juegos interactivos, Three.js, motion graphics, CLI, rendimiento, visión y límites de agentes
...
| Section | Cases |
|---|---|
| [Juegos interactivos y 3D](#games-3d) | 4 |
| [Frontend y diseño en movimiento](#frontend-motion) | 2 |
| [Programación e integraciones](#coding-integrations) | 2 |
| [Evaluación y límites](#evaluation-limits) | 2 |
...
<a id="case-7"></a>
### Case 7: [Acceder a Kimi K3 desde Kimi CLI](https://x.com/TheAhmadOsman/status/2077750074608644127) (by [@TheAhmadOsman](https://x.com/TheAhmadOsman))

**Usa Kimi CLI tras comprobar la documentación y el selector actuales**

El creador anuncia Kimi K3 en Kimi CLI. El repositorio no infiere instalación ni autenticación a partir del anuncio
...
<a id="case-8"></a>
### Case 8: [Observar rendimiento en OpenRouter mediante Moonshot API](https://x.com/scaling01/status/2077777932341092422) (by [@scaling01](https://x.com/scaling01))

**Registra proveedor, ruta y tokens por segundo al comparar rendimiento**

Un usuario observa 28 tokens por segundo. Es una observación única, no un benchmark ni una garantía
...
<a id="case-9"></a>
### Case 9: [Probar visión con tu propia carga de trabajo](https://x.com/mitsuhiko/status/2077770239937282526) (by [@mitsuhiko](https://x.com/mitsuhiko))

**Evalúa visión con tareas representativas antes de generalizar**

Armin Ronacher informa de buena calidad visual en sus cargas. Es una experiencia personal, no un benchmark
...
<a id="case-10"></a>
### Case 10: [Vigilar bucles con esfuerzo máximo](https://x.com/emollick/status/2077770187521069152) (by [@emollick](https://x.com/emollick))

**Define criterios de parada cuando el agente revisita trabajo terminado**

Ethan Mollick observa revisiones repetidas a esfuerzo máximo. La fuente no aísla si procede del modelo, del harness o de ambos
