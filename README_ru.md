...
Все 89 сценариев основаны на публичных источниках высокой достоверности. Заголовки и авторы ведут к оригиналам; слабые, дублирующие и недостаточно подтвержденные кандидаты исключены

## 📊 Обзор

- 109 сценариев с высокой достоверностью и широким охватом задач
...
| Section | Cases |
|---|---|
| [Интерактивные игры и 3D](#games-3d) | 37 |
| [Frontend и motion-дизайн](#frontend-motion) | 25 |
| [Код и интеграции](#coding-integrations) | 14 |
| [Оценка и ограничения](#evaluation-limits) | 43 |
