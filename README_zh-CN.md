...
全部 79 个案例均来自高置信公开来源；标题和作者链接回原文，弱证据、重复或证据不足的候选不会收录
...
1. [创建或管理 EvoLink API 密钥](https://evolink.ai/dashboard/keys?utm_source=github&utm_medium=quickstart&utm_campaign=awesome-kimi-k3-usecases&utm_content=api_key)
2. [查看 EvoLink Kimi K3 API 文档](https://docs.evolink.ai/en/api-manual/language-series/kimi-k3/kimi-k3-chat?utm_source=github&utm_medium=docs&utm_campaign=awesome-kimi-k3-usecases&utm_content=docs_link)
...
| Section | Cases |
|---|---|
| [互动游戏与 3D](#games-3d) | 25 |
| [前端与动态设计](#frontend-motion) | 16 |
| [编程与集成](#coding-integrations) | 10 |
| [评估与限制](#evaluation-limits) | 28 |
