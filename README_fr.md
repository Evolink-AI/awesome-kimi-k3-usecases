...
<a href="https://evolink.ai/?utm_source=github&utm_medium=banner&utm_campaign=awesome-kimi-k3-usecases&utm_content=readme_banner"><img src="https://pub-62cf7640cd0f4066b60933bd2e9b85ef.r2.dev/github-repo-media/awesome-kimi-k3-usecases/images/fr.png" alt="Kimi K3 usecase repository banner" width="760"></a>
...
Les dix cas de cette première édition proviennent uniquement du dossier fourni. Les titres et auteurs renvoient aux sources originales
...
- 10 cas sélectionnés de créateurs et praticiens
- Jeux, Three.js, motion design, CLI, débit, vision et limites d’agents
- Chaque cas conserve source, auteur, type, date et limite du prompt
- Les observations individuelles ne deviennent pas des benchmarks
...
L’identifiant officiel est `kimi-k3`. La documentation officielle fournit la liste des modèles et un guide dédié

1. [Consulter la liste officielle des modèles Kimi](https://platform.kimi.ai/docs/models)
2. [Exécuter Kimi K3 avec le guide officiel](https://platform.kimi.ai/docs/guide/kimi-k3-quickstart)
3. [Explorer l’accès aux modèles sur EvoLink](https://evolink.ai/?utm_source=github&utm_medium=quickstart&utm_campaign=awesome-kimi-k3-usecases&utm_content=model_access)
4. [Créer ou gérer une clé API EvoLink](https://evolink.ai/dashboard/keys?utm_source=github&utm_medium=quickstart&utm_campaign=awesome-kimi-k3-usecases&utm_content=api_key)

> [!IMPORTANT]
> Ce dépôt n’a pas vérifié Kimi K3 sur EvoLink et ne publie donc ni endpoint, ni tarif, ni exemple d’appel propre à EvoLink

## 📑 Menu

| Section | Cases |
|---|---|
| [Jeux interactifs et 3D](#games-3d) | 4 |
| [Frontend et motion design](#frontend-motion) | 2 |
| [Code et intégrations](#coding-integrations) | 2 |
| [Évaluation et limites](#evaluation-limits) | 2 |
...
<a id="case-7"></a>
### Case 7: [Accéder à Kimi K3 via Kimi CLI](https://x.com/TheAhmadOsman/status/2077750074608644127) (by [@TheAhmadOsman](https://x.com/TheAhmadOsman))

**Vérifier la documentation et le sélecteur actuels avant d’utiliser la CLI**

L’auteur annonce Kimi K3 dans Kimi CLI. Le dépôt n’en déduit pas les étapes d’installation ou d’authentification
...
<a id="case-8"></a>
### Case 8: [Observer le débit OpenRouter via Moonshot API](https://x.com/scaling01/status/2077777932341092422) (by [@scaling01](https://x.com/scaling01))

**Noter fournisseur, route et tokens par seconde**

Un utilisateur observe 28 tokens par seconde. C’est une observation unique, pas un benchmark ni une garantie
...
<a id="case-9"></a>
### Case 9: [Tester la vision sur sa propre charge](https://x.com/mitsuhiko/status/2077770239937282526) (by [@mitsuhiko](https://x.com/mitsuhiko))

**Évaluer des tâches représentatives avant toute généralisation**

Armin Ronacher rapporte une bonne qualité visuelle sur ses tâches. C’est une expérience personnelle, pas un benchmark
...
<a id="case-10"></a>
### Case 10: [Surveiller les boucles à effort maximal](https://x.com/emollick/status/2077770187521069152) (by [@emollick](https://x.com/emollick))

**Définir des critères d’arrêt quand le travail terminé est repris**

Ethan Mollick observe des modifications répétées. La source ne distingue pas le modèle, le harness ou leur interaction
...
- [Consulter la liste officielle des modèles Kimi](https://platform.kimi.ai/docs/models)
- [Exécuter Kimi K3 avec le guide officiel](https://platform.kimi.ai/docs/guide/kimi-k3-quickstart)
- Aucune page API ni skill EvoLink installable propre à Kimi K3 n’a été vérifiée pour cette édition
