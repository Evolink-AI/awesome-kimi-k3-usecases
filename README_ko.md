...
- 크리에이터와 실무자의 사례 10개
- 게임, Three.js, 모션, CLI, 처리량, 비전, 에이전트 한계
...
| Section | Cases |
|---|---|
| [인터랙티브 게임과 3D](#games-3d) | 4 |
| [프론트엔드와 모션 디자인](#frontend-motion) | 2 |
| [코딩과 통합](#coding-integrations) | 2 |
| [평가와 한계](#evaluation-limits) | 2 |
...
<a id="case-7"></a>
### Case 7: [Kimi CLI에서 Kimi K3 사용하기](https://x.com/TheAhmadOsman/status/2077750074608644127) (by [@TheAhmadOsman](https://x.com/TheAhmadOsman))

**현재 문서와 모델 선택기를 확인한 뒤 CLI를 사용합니다**

제작자는 Kimi CLI 제공을 알렸습니다. 저장소는 설치나 인증 단계를 추정하지 않습니다
...
<a id="case-8"></a>
### Case 8: [Moonshot API 경유 처리량 관찰하기](https://x.com/scaling01/status/2077777932341092422) (by [@scaling01](https://x.com/scaling01))

**공급자, 경로와 초당 토큰을 기록합니다**

한 사용자가 초당 28토큰을 관찰했습니다. 단일 관찰이며 벤치마크나 보장이 아닙니다
...
<a id="case-9"></a>
### Case 9: [자신의 작업으로 비전 품질 시험하기](https://x.com/mitsuhiko/status/2077770239937282526) (by [@mitsuhiko](https://x.com/mitsuhiko))

**대표 작업에서 평가한 뒤 일반화합니다**

Armin Ronacher는 자신의 작업에서 높은 비전 품질을 보고했습니다. 개인 경험이며 벤치마크가 아닙니다
...
<a id="case-10"></a>
### Case 10: [최대 노력에서 반복 루프 감시하기](https://x.com/emollick/status/2077770187521069152) (by [@emollick](https://x.com/emollick))

**완료 작업을 반복 수정하면 중단 기준을 둡니다**

Ethan Mollick는 반복 수정을 관찰했습니다. 원인이 모델, harness 또는 상호작용인지는 분리되지 않았습니다
